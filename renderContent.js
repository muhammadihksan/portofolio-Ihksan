export function RenderContent(){
  ...
  const homeDetails = {
    ...
    name: 'Muh.Ihksan Hatta',
    profilePhoto: 'profile.jpg',
    welcomeTxt: 'Welcome to my personal website.',
    fbLink: '',
    tiktokLink: 'https://www.tiktok.com/@mrv_rbt?_t=ZS-8skdZZYkfzE&_r=1',
    instagramLink: 'https://www.instagram.com/muhammad_ihksan_hatta/',
    ytLink: 'https://www.youtube.com/@muhammadihksanhatta1986'
  }
  ...
  const homeSection = document.querySelector('#home-section').innerHTML = homeHTML;
   ...
   const aboutDetails = {
    myPhoto: 'profile.jpg',
    aboutMeFirstPrgrph: `Hi! I'm Ihksan, saya adalah seorang yang haus atas materi yang belum saya pernah dapatkan, khususnya pada ilmu sosial,ilmu agama dan ilmu lainnya. Saya mahasiswa teknik telekomunikasi yang becita-cita ingin memahami dan mengetahui segala bentuk pengetahuan pada bidang yang saya minati. `,
    aboutMeSecondPrgrph: `“Keberhasilan bukanlah tentang siapa yang paling cepat, namun siapa yang paling konsisten untuk terus melangkah.”`
   }
  ...
  const aboutSection = document.querySelector('#about-section').innerHTML = aboutHTML;
    ...
    const skills = [
      ...
      { iconName: "music.png", skillName: "Musik" },
      ...
      { iconName: "py.jpg", skillName: "Python" },
      { iconName: "Matlab.jpg", skillName: "Matlab" },
      { iconName: "figma.jpg", skillName: "desain" },
      { iconName: "capcut.jpg", skillName: "editor" },
      { iconName: "Voli", skillName: "Olahraga" },
    ];
